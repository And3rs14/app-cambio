          ...
          <div class="card-body ">
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Estoy de acuerdo con la ') }} <a href="#" style="color: #2450aa;">{{ __('Politica de privacidad') }}</a>
              </label>
            </div>
          </div>
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-primary btn-link btn-lg" style="color: #2450aa;">{{ __('Crear cuenta') }}</button>
          </div>
        </div>
      </form>
    </div>
