...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>App de tipo de cambio</title>
                    ...
                    <section class="pb-5 position-relative bg-gradient-dark mx-n3">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="card card-profile mt-4" style = "background:#2c2c2c" >
                                    <div class="row ">
                                        <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                            <a href="javascript:;">
                                                <div class="p-3 pe-md-0">
                                                    <img class="w-100 border-radius-md shadow-lg" src="/img/bill.png" alt="image">
                                                </div>
                                            </a>
                                        </div>
                                ...
                                <div class="card card-profile mt-4" style = "background:#2c2c2c" >
                                    <div class="row ">
                                        <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                            <a href="javascript:;">
                                                <div class="p-3 pe-md-0">
                                                    <img class="w-100 border-radius-md shadow-lg" src="/img/tercer.png" alt="image">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-lg-8 col-md-6 col-12 my-auto ">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="card card-profile mt-lg-4 mt-5" style = "background: #2c2c2c">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                            <a href="javascript:;">
                                                <div class="p-3 pe-md-0">
                                                    <img class="w-100 border-radius-md shadow-lg" src="/img/jammyr.png" alt="image">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-lg-8 col-md-6 col-12 my-auto">
                                ...
                                <div class="card card-profile mt-lg-4 mt-5" style = "background: #2c2c2c">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                            <a href="javascript:;">
                                                <div class="p-3 pe-md-0">
                                                    <img class="w-100 border-radius-md shadow-lg" src="/img/jefferson.png" alt="image">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-lg-8 col-md-6 col-12 my-auto">
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-6 col-12">
                                <div class="card card-profile mt-4 z-index-2" style = "background:#2c2c2c">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                            <a href="javascript:;">
                                                <div class="p-3 pe-md-0">
                                                    <img class="w-100 border-radius-md shadow-lg" src="../img/piero.png" alt="image">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-lg-8 col-md-6 col-12 my-auto">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="card card-profile mt-lg-4 mt-5 z-index-2" style = "background:#2c2c2c">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                            <a href="javascript:;">
                                                <div class="p-3 pe-md-0">
                                                    <img class="w-100 border-radius-md shadow-lg" src="../img/jans.png" alt="image">
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-lg-8 col-md-6 col-12 my-auto">
